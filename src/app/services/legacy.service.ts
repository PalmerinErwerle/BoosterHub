...
export class LegacyService {
  ...
  raidsCollection: AngularFirestoreCollection<Legacy> = this.angularFire.collection<Legacy>('legacies');
  ...
  createRaid(form: FormGroup) {
      ...
      this.firebaseService.postDocument(path, form.value).then(async res => {
          ...
          this.toaster.successToast("Legacy raid service created succesfully");
          this.utilsService.reload("/home/legacy/" + res.id, 2000);
      }).catch(er => {
  ...
  updateRaid(form: FormGroup, id: string) {
      let path = "legacies/" + id;
      this.spinner.showSpinner();

      this.firebaseService.updateDocument(path, form.value).then(async () => {
          this.toaster.successToast("Legacy raid service updated succesfully");
          this.utilsService.reload("/home/legacy/" + id, 2000);
      }).catch(er => {
  ...
  getRaidsByAdviser(adviser_id: string): Promise<Legacy[]> {
  ...
  getRaidsByTank1(tank1_id: string): Promise<Legacy[]> {
  ...
  getRaidsByTank2(tank2_id: string): Promise<Legacy[]> {
  ...
  getRaidsByHealer1(healer1_id: string): Promise<Legacy[]> {
  ...
  getRaidsByHealer2(healer2_id: string): Promise<Legacy[]> {
  ...
  getRaidsByDps1(dps1_id: string): Promise<Legacy[]> {
  ...
  getRaidsByDps2(dps2_id: string): Promise<Legacy[]> {
  ...
  getRaidsByDps3(dps3_id: string): Promise<Legacy[]> {
  ...
  getRaidsByDps4(dps4_id: string): Promise<Legacy[]> {
  ...
  getRaidsByDps5(dps5_id: string): Promise<Legacy[]> {
  ...
  getRaidsByDps6(dps6_id: string): Promise<Legacy[]> {
